...
class Qwen3VLTextRotaryEmbedding:
    def __init__(self, config: Qwen3VLTextConfig, device=None):
        ...
        self.inv_freq_expanded_cache = self.inv_freq[None, None, :, None].float().expand(3, 1, -1, 1).to('cuda')
    ...
    def __call__(self, x, position_ids):
        ...
        inv_freq_expanded = self.inv_freq_expanded_cache
...
class Qwen3VLTextDecoderLayer:
    ...
    def prefill(
        ...
        # Self Attention
        hidden_states = self.self_attn.prefill(
...
class Qwen3VLTextModel:
    ...
    def forward_prefill(
        ...
        for layer_idx, decoder_layer in enumerate(self.layers):
            layer_outputs = decoder_layer.prefill(
                hidden_states,
                attention_mask=None,
...
class Qwen3VLModel:
    ...
    def forward_decode(
        ...
        position_ids = ((pos_idx + self.rope_deltas)
...
class Qwen3VLForCausalLM:
    ...
    def generate(self, prompts=None, images=None, generated_len=128, temperature=1.0, do_sample=True,
        ...
        logits = self.forward_prefill(
            ...
            past_key_values=self.kv_cache,  # Prefill 阶段
            image_grid_thw=image_grid_thw,
            position_ids=None,
            attention_mask=attention_mask,
        )
